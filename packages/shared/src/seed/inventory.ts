...
const PRESETS: Record<string, ItemSeed[]> = {
  ...
  laundry: [
    ...
    { name: 'Stain Remover', sku: 'LN-STN-001', unit: 'each', quantity: 20, reorder_threshold: 5 },
    { name: 'Garment Bags', sku: 'LN-BAG-001', unit: 'each', quantity: 20, reorder_threshold: 5 },
    { name: 'Hangers', sku: 'LN-HNG-001', unit: 'box', quantity: 20, reorder_threshold: 5 },
  ],
  car_wash: [
    { name: 'Car Wash Soap', sku: 'CW-SOP-001', unit: 'each', quantity: 20, reorder_threshold: 5 },
    {
    ...
    { name: 'Wax & Polish', sku: 'CW-WAX-001', unit: 'each', quantity: 20, reorder_threshold: 5 },
    {
    ...
    { name: 'Tire Shine', sku: 'CW-TIR-001', unit: 'each', quantity: 20, reorder_threshold: 5 },
    { name: 'Air Fresheners', sku: 'CW-AIR-001', unit: 'box', quantity: 20, reorder_threshold: 5 },
  ],
  tattoo: [
    {
      name: 'Tattoo Ink Sets',
      sku: 'TAT-INK-001',
      unit: 'each',
      quantity: 20,
      reorder_threshold: 5,
