...
const PRESETS: PackagePreset[] = [
  {
    ...
    serviceNames: ['Comprehensive Exam', 'Full Mouth X-Ray', 'Teeth Cleaning'],
    discountPct: 15,
  },
  {
    vertical: 'salon',
  ...
  {
    vertical: 'contractor',
    name: 'Deck Build Package',
    serviceNames: ['Site Assessment', 'Deck Construction', 'Deck Staining/Sealing'],
    discountPct: 10,
  },
  {
    vertical: 'law_firm',
    name: 'Consultation + Intake',
    serviceNames: ['Initial Consultation', 'Retainer Agreement'],
    discountPct: 8,
  },
  {
    vertical: 'real_estate',
    name: 'Listing Package',
    serviceNames: ['Property Listing', 'Professional Photography', 'Virtual Tour'],
    discountPct: 10,
  },
  {
    vertical: 'restaurant',
    name: 'Event Catering Package',
    serviceNames: ['Catering Service', 'Event Planning', 'Beverage Package'],
    discountPct: 10,
  },
  {
    vertical: 'sales_crm',
    name: 'Onboarding Package',
    serviceNames: ['Onboarding Session', 'CRM Setup', 'Training Workshop'],
    discountPct: 10,
  },
]
