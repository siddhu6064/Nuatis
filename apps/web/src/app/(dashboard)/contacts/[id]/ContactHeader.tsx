    ...
    <>
      <div className="flex items-start gap-4 mb-8">
        ...
        <button
          ...
          className="shrink-0 inline-flex items-center gap-1.5 rounded-lg border border-gray-200 bg-white px-3 py-1.5 text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors"
        >
          <svg
            width="13"
            height="13"
...
function EditDrawer({
  ...
  const inp = (hasErr: boolean) =>
    `w-full px-3 py-2 text-sm border rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent ${
      hasErr ? 'border-red-300 focus:ring-red-400' : 'border-gray-200'
    }`
