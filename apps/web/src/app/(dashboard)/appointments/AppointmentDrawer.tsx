    ...
    >
      {isEditing ? (
        ...
        <div className="px-6 py-5 space-y-5">
          <div>
            <p className="text-xs font-medium text-ink4 uppercase tracking-wide mb-1">Contact</p>
            <p className="text-sm font-semibold text-ink">{localAppt.contacts?.full_name ?? '—'}</p>
          </div>
          ...
          {localAppt.staff_members && (
            <div>
              <p className="text-xs font-medium text-ink4 uppercase tracking-wide mb-1">Staff</p>
