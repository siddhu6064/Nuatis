...
read -rp "OUTLOOK_CLIENT_ID: " OUTLOOK_CLIENT_ID
read -rp "OUTLOOK_CLIENT_SECRET: " OUTLOOK_CLIENT_SECRET
...
read -rp "TELNYX_CONNECTION_ID: " TELNYX_CONNECTION_ID
...
[ -n "$OUTLOOK_CLIENT_ID" ] && ENV_ARGS+="OUTLOOK_CLIENT_ID=$OUTLOOK_CLIENT_ID "
[ -n "$OUTLOOK_CLIENT_SECRET" ] && ENV_ARGS+="OUTLOOK_CLIENT_SECRET=$OUTLOOK_CLIENT_SECRET "
...
[ -n "$TELNYX_CONNECTION_ID" ] && ENV_ARGS+="TELNYX_CONNECTION_ID=$TELNYX_CONNECTION_ID "
